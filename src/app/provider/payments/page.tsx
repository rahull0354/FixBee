...
export default function ProviderPaymentsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 py-6 sm:py-8">
      ...
      {/* Banner Section - Earnings Summary */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-amber-100 p-4 sm:p-6">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mb-1">Pending Earnings</p>
          <p className="text-2xl sm:text-3xl font-bold text-gray-900">
        ...
        {/* Total Services */}
        <div className="bg-white rounded-2xl shadow-lg border border-sky-100 p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="p-2 sm:p-3 bg-sky-100 rounded-xl">
              <Building className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600" />
            </div>
          </div>
          <p className="text-xs sm:text-sm text-gray-600 mb-1">Total Services</p>
          <p className="text-2xl sm:text-3xl font-bold text-gray-900">
            {payments.length}
          </p>
        </div>
            ...
            <div className="flex-1 relative w-full">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-emerald-600 transition-colors"
                >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex-1 space-y-2 sm:space-y-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="flex items-center gap-2 text-emerald-600 font-semibold">
                      ...
                      <span className="text-sm sm:text-base">{payment.invoiceNumber}</span>
                    </div>
                ...
                <div className="flex sm:flex-col items-start sm:items-end gap-3 sm:gap-4">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => router.push(`/provider/payments/${payment.id}`)}
    ...
    <div className="text-center py-12 sm:py-16">
      ...
      <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 max-w-md mx-auto">
        {searchQuery
          ...
          : 'Your completed service payments will appear here once customers complete payment'}
      </p>
      {statusFilter !== 'all' && (
        <Button
          variant="outline"
