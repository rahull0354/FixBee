  ...
  const loadInvoiceAndCreateIntent = async () => {
    try {
      ...
      try {
        ...
        toast.error(
          invoiceError?.response?.data?.message || "Failed to load invoice",
        );
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-2 border-sky-100 shadow-xl overflow-hidden">
              <CardContent className="p-0">
                <div className="bg-linear-to-br from-sky-500 via-blue-500 to-indigo-600 p-6 text-white">
            ...
            {creatingIntent ? (
              ...
              <Card className="border-2 border-red-100 shadow-xl p-8">
                <div className="text-center">
                  ...
                  <Button onClick={loadInvoiceAndCreateIntent} className="mt-4">
                    Try Again
                  </Button>
                </div>
              </Card>
