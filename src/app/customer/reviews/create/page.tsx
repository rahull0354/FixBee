...
export default function CreateReviewPage() {
  ...
  const loadRequest = async () => {
    try {
      ...
      // Extract the actual service request from the nested response
      const serviceRequestData: ServiceRequest = apiData.request || apiData;

      if (serviceRequestData.status !== 'completed') {
  ...
  const SmallStarRating = ({
    ...
    return (
      <div className={`flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 p-3 sm:p-4 rounded-xl ${bgColors[color as keyof typeof bgColors]}`}>
      ...
      <div className="bg-linear-to-r from-sky-500 via-blue-500 to-indigo-600 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-3 sm:gap-5">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 truncate">{serviceRequest.title || serviceRequest.serviceTitle}</h2>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-sky-100 p-4 sm:p-6 lg:p-8">
              <div className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Rate different aspects of the service</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-sky-100 p-4 sm:p-6 lg:p-8">
              <div className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Share details about your experience (minimum 10 characters)</p>
                </div>

                <Textarea
                  id="comment"
                  rows={8}
                  placeholder="Share your experience. Was the service provider professional? Did they complete the work on time? Would you recommend them to others?"
                  {...register('comment')}
          ...
          <div className="lg:col-span-1 space-y-4 sm:space-y-6 order-1 lg:order-2">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-sky-100 p-4 sm:p-6 lg:p-8 lg:sticky lg:top-8">
              <div className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">How was your experience?</p>
                </div>
            ...
            <div className="bg-linear-to-br from-sky-50 via-blue-50 to-indigo-50 border border-sky-200 rounded-2xl p-4 sm:p-6">
              ...
              <ul className="text-xs sm:text-sm text-sky-800 space-y-1 sm:space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-sky-600 font-bold shrink-0">•</span>
                  <span>Mention punctuality & professionalism</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-sky-600 font-bold shrink-0">•</span>
                  <span>Describe quality of work</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-sky-600 font-bold shrink-0">•</span>
