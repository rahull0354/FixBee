  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="bg-linear-to-br from-sky-500 via-blue-500 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="p-4 bg-white/20 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-white/30">
              <Briefcase className="h-8 w-8 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold mb-1">Create Service Request</h1>
              <p className="text-sky-100">Fill in the details to book a home service</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mt-6">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-sm font-bold border border-white/30">
                1
              </div>
              <span className="text-sm text-sky-100">Choose Service</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-sky-100">Provide Details</span>
            </div>
            <div className="flex-1 h-0.5 bg-white/20" />
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-sm font-bold border border-white/30">
              ...
              <span className="text-sm text-sky-100">Schedule</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-sky-100 overflow-hidden">
          <div className="bg-linear-to-r from-sky-50 to-blue-50 px-6 py-4 border-b border-sky-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-800">Service Category</h2>
                <p className="text-xs text-gray-600">Select the type of service you need</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-4">
            ...
            {categoriesLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-800 font-semibold mb-2">No categories found</p>
        ...
        {/* Service Details */}
        <div className="bg-white rounded-2xl shadow-xl border border-sky-100 overflow-hidden">
          <div className="bg-linear-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-sky-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Tell us more about what you need</p>
              </div>
            </div>
          </div>
        ...
        {/* Schedule and Address - Side by Side */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Schedule */}
          <div className="bg-white rounded-2xl shadow-xl border border-sky-100 overflow-hidden">
            <div className="bg-linear-to-r from-emerald-50 to-teal-50 px-6 py-4 border-b border-sky-100">
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-sky-100 overflow-hidden">
            <div className="bg-linear-to-r from-violet-50 to-purple-50 px-6 py-4 border-b border-sky-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Where should the provider come?</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
            <div className="space-y-2">
              <Label htmlFor="address.street" className="text-sm font-semibold text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="address.city" className="text-sm font-semibold text-gray-700">
              ...
              <div className="space-y-2">
                <Label htmlFor="address.state" className="text-sm font-semibold text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="address.zipCode" className="text-sm font-semibold text-gray-700">
              ...
              <div className="space-y-2">
                <Label htmlFor="address.country" className="text-sm font-semibold text-gray-700">
                  Country (Optional)
                </Label>
                <Input
                  id="address.country"
        ...
        {/* Submit Buttons */}
        <div className="bg-linear-to-br from-sky-50 via-blue-50 to-indigo-50 rounded-2xl p-8 shadow-xl border border-sky-100">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.back()}
              className="w-full sm:w-auto px-8 py-3 border-gray-200 text-gray-700 hover:bg-gray-100 font-semibold text-base"
            >
            ...
            <Button
              ...
              className="w-full sm:w-auto px-10 py-3 bg-linear-to-r from-sky-400 via-blue-400 to-indigo-400 hover:from-sky-500 hover:via-blue-500 hover:to-indigo-500 text-white font-semibold shadow-lg hover:shadow-xl transition-all text-base"
            >
