    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            "w-full justify-start text-left font-normal border-emerald-200 hover:border-emerald-300 hover:bg-emerald-50 h-9 sm:h-10 md:h-12 rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base",
            !value && "text-gray-500"
          )}
          style={{ backgroundColor: 'white' }}
        >
          <Clock className="mr-1.5 sm:mr-2 h-3.5 w-3.5 sm:h-4 sm:w-4 text-emerald-600" />
          {value ? (
      ...
      <PopoverContent className="w-[95vw] max-w-[320px] sm:max-w-[340px] md:max-w-[360px] p-0 border-emerald-200 shadow-xl rounded-lg sm:rounded-xl" align="start">
        <div className="p-3 sm:p-4 md:p-5 bg-white">
          {/* Time Slot Info */}
          {timeSlot && validHours && (
            <div className="mb-3 sm:mb-4 p-2 sm:p-2.5 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg sm:rounded-xl">
              <p className="text-[10px] sm:text-xs font-semibold text-emerald-900 mb-1 sm:mb-1.5">
          ...
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 md:gap-3 mb-4 sm:mb-5">
            ...
            <div className="flex flex-col items-center flex-1">
              <button
                ...
                className="p-1 sm:p-1.5 md:p-2 hover:bg-emerald-50 rounded-lg transition-colors group"
              >
                <ChevronUp className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 text-gray-600 group-hover:text-emerald-600" />
              </button>
              <div className={cn(
                ...
                <span className={cn(
                  ...
                  isHourValid(hour, period) ? "text-emerald-700" : "text-gray-500"
              ...
              <button
                ...
                className="p-1 sm:p-1.5 md:p-2 hover:bg-emerald-50 rounded-lg transition-colors group"
              >
                <ChevronDown className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 text-gray-600 group-hover:text-emerald-600" />
              </button>
            </div>
            ...
            <div className="flex flex-col items-center flex-1">
              ...
              <div className="w-12 sm:w-16 md:w-20 h-10 sm:h-12 md:h-14 flex items-center justify-center bg-linear-to-r from-emerald-50 to-teal-50 border-2 border-emerald-200 rounded-lg sm:rounded-xl my-0.5 sm:my-1">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-emerald-700">{String(minute).padStart(2, '0')}</span>
              </div>
              <button
                type="button"
                onClick={() => handleMinuteChange(-1)}
            ...
            <button
              ...
              className={cn(
                ...
                period === 'AM'
                  ? "bg-linear-to-r from-emerald-400 via-teal-400 to-cyan-400 text-white"
                  : "bg-linear-to-r from-teal-500 via-emerald-500 to-green-500 text-white",
            ...
            <div className={cn(
              ...
              {quickTimes.map((time) => (
                <button
                  ...
                  className="px-1.5 sm:px-2.5 md:px-3 py-1.5 sm:py-2 text-[10px] sm:text-xs md:text-sm font-medium rounded-lg sm:rounded-xl border border-emerald-200 text-emerald-700 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200"
                >
                  {time.label}
                </button>
              ))}
