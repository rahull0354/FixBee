  ...
  return (
    <div className="h-screen w-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-full bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-32 left-16 w-20 h-20 bg-linear-to-br from-emerald-400 to-emerald-500 rounded-3xl shadow-2xl transform rotate-12 animate-float" />
