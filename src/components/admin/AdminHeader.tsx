...
export function AdminHeader({ user, onMenuClick }: AdminHeaderProps) {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-xl shadow-sm border-b border-rose-100 sticky top-0 z-20">
      <div className="flex items-center justify-between px-4 lg:px-8 py-5">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Page title */}
          <div>
            <h1 className="text-xl lg:text-2xl font-bold bg-linear-to-r from-rose-500 via-red-500 to-pink-500 bg-clip-text text-transparent">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              <div className="w-10 h-10 bg-linear-to-br from-rose-400 to-red-500 rounded-full flex items-center justify-center text-white font-semibold shadow-md hover:shadow-lg transition-shadow">
            ...
            {showDropdown && (
              <>
                ...
                />
                <div className="fixed left-4 right-4 sm:absolute sm:left-auto sm:right-0 sm:w-56 top-[72px] sm:mt-2 bg-white rounded-xl shadow-lg border border-rose-100 py-2 z-50">
                  {/* User Info Section */}
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-3 text-gray-700 hover:bg-rose-50 transition-colors"
                  >
